...
export default function PurchaseDetail() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      if (!cancelled) {
        ...
        for (const [i, url] of entries) next[i] = url;
        setImgByIndex(next);
      }
    }
  ...
  }, [p?.id, p?.itens, updatePurchaseItemInContext]);
      ...
      <div className="mb-3 flex items-center justify-between">
        ...
        <div className="min-w-0 flex-1 px-2">
          ...
          <div className="truncate text-sm text-gray-500">
            {dateOnlyDisplay(p.createdAt)} · {p.market || "—"} ·{" "}
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200">
        {p.itens?.map((it: any, i: number) => {
          ...
          return (
            <div
              key={i}
              className="flex items-start justify-between border-b border-gray-100 p-4 last:border-b-0"
            >
              <div className="mr-3 h-12 w-12 shrink-0 overflow-hidden rounded-xl bg-gray-100">
                <img
                  src={img}
                  alt={it?.nome || "Produto"}
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={edit.unidade}
                      onChange={(e) =>
                        setEdit({ ...edit, unidade: e.target.value })
                      }
                    />
                  </div>
                  <div>
