...
export default function PurchasesReceipt() {
  ...
  const createFromReceipt = dataCtx?.createPurchaseFromReceiptInContext || dataCtx?.createPurchaseInContext;
        ...
        <>
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <input value={market} onChange={(e) => setMarket(e.target.value)} placeholder="Ex.: Carrefour"
            ...
            <div>
              ...
              <input value={listName} onChange={(e) => setListName(e.target.value)} placeholder="Ex.: Compra do mês"
                className="w-full rounded-2xl border border-gray-200 px-4 py-3 focus:ring-2 focus:ring-yellow-400" />
            </div>
            <div>
